...
public class AdminSunTimesController {
    ...
    @GetMapping public List<SunTimesAdminDto> all() { return service.findAll(); }

    @PostMapping @ResponseStatus(HttpStatus.CREATED)
    public SunTimesAdminDto create(@Valid @RequestBody SunTimesUpsertDto dto) { return service.create(dto); }

    @PatchMapping("/{id}")
    public SunTimesAdminDto patch(@PathVariable Long id, @RequestBody SunTimesPatchDto dto) { return service.patch(id, dto); }
