...
public class AdminCityController {
    ...
    @GetMapping public List<CityAdminDto> all() { return service.findAll(); }

    @PostMapping @ResponseStatus(HttpStatus.CREATED)
    public CityAdminDto create(@Valid @RequestBody CityUpsertDto dto) { return service.create(dto); }

    @PatchMapping("/{id}")
    public CityAdminDto patch(@PathVariable Long id, @RequestBody CityPatchDto dto) { return service.patch(id, dto); }
